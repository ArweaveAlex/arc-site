...
export function poolsReducer(state: PoolsType = initStatePools, action: ReduxActionType) {
	switch (action.type) {
		case SET_POOLS:
...
export function poolsSearchReducer(state: PoolsSearchIndexType = initStatePoolsSearch, action: ReduxActionType) {
	switch (action.type) {
