  ...
  switch (action.type) {
    case SET_SEARCH_IDS:
      return Object.assign({}, state, {
        [REDUX_TABLES.accountAll]: checkPayload(
          action.payload,
          REDUX_TABLES.accountAll
        )
        ...
        [REDUX_TABLES.poolAll]: checkPayload(
          action.payload,
          REDUX_TABLES.poolAll
        )
          ? action.payload[REDUX_TABLES.poolAll]
          : state[REDUX_TABLES.poolAll],
        [REDUX_TABLES.libraryAll]: checkPayload(
          action.payload,
          REDUX_TABLES.libraryAll
        )
...
export function searchIndecesReducer(
  state: SearchIndecesType = initStateSearchIndeces,
  action: ReduxActionType
) {
  switch (action.type) {
