...
export const Primary = styled.div<{
  ...
  min-width: ${(props) =>
    props.noMinWidth ? "none" : STYLING.dimensions.buttonWidth};
  max-width: ${(props) =>
    props.useMaxWidth ? STYLING.dimensions.buttonWidth : "none"};
  overflow: hidden;
  ...
  &:disabled {
    ...
    border: 1.5px solid
      ${(props) => props.theme.colors.button.primary.disabled.border};
    span {
      color: ${(props) => props.theme.colors.button.primary.disabled.label};
    }
  }
...
export const Alt1 = styled(Primary)`
  ...
  &:hover {
    border: 1.5px solid
      ${(props) =>
        props.active ? "transparent" : props.theme.colors.button.alt1.border};
    background: ${(props) =>
      props.active
        ? props.theme.colors.button.alt1.active.hover
        : props.theme.colors.button.alt1.hover};
  }
  &:focus {
    border: 1.5px solid
      ${(props) =>
  ...
  &:disabled {
    ...
    border: 1.5px solid
      ${(props) => props.theme.colors.button.alt1.disabled.border};
    span {
      color: ${(props) => props.theme.colors.button.alt1.disabled.label};
    }
  }
...
export const Alt2 = styled(Primary)`
  ...
  border: 1.25px solid
    ${(props) =>
      props.active
        ? props.theme.colors.button.alt2.active.background
        : props.theme.colors.button.alt2.border};
  &:hover {
    border: 1.25px solid
      ${(props) =>
        props.active
          ? props.theme.colors.button.alt2.active.hover
          : props.theme.colors.button.alt2.border};
    background: ${(props) =>
      props.active
        ? props.theme.colors.button.alt2.active.hover
        : props.theme.colors.button.alt2.hover};
  }
  &:focus {
    border: 1.25px solid
      ${(props) =>
  ...
  &:disabled {
    ...
    border: 1.25px solid
      ${(props) => props.theme.colors.button.alt2.disabled.border};
    span {
      color: ${(props) => props.theme.colors.button.alt2.disabled.label};
    }
  }
