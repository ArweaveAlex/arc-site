...
export const Alt1 = styled(Primary)`
    background: ${(props) => props.active ? 
      props.theme.colors.button.alt1.active.background : props.theme.colors.button.alt1.background};
    border: 1.5px solid ${(props) => props.theme.colors.button.alt1.border};
    &:hover {
      border: 1.5px solid ${(props) => props.active ? 
        "transparent" : props.theme.colors.button.alt1.border};
      background: ${(props) => props.active ? 
        props.theme.colors.button.alt1.active.hover : props.theme.colors.button.alt1.hover};
    }
    &:focus {
      border: 1.5px solid ${(props) => props.active ? 
        "transparent" : props.theme.colors.button.alt1.border};
    ...
    span {
      color: ${(props) => props.active ? 
        props.theme.colors.button.alt1.active.label : props.theme.colors.button.alt1.label};
    }
`;
...
export const IconSecondary = styled(IconPrimary)`
  svg {
      fill: ${(props) => props.disabled ?
      props.theme.colors.button.alt1.disabled.label : props.active ? 
      props.theme.colors.button.alt1.active.label : props.theme.colors.button.alt1.label};
  }
`;
...
export const Alt2 = styled(Primary)`
  background: ${(props) => props.active ? 
    props.theme.colors.button.alt2.active.background : props.theme.colors.button.alt2.background};
  border: 1.25px solid ${(props) => props.active ? 
    props.theme.colors.button.alt2.active.background : props.theme.colors.button.alt2.border};
  &:hover {
    border: 1.25px solid ${(props) => props.active ? 
      props.theme.colors.button.alt2.active.hover : props.theme.colors.button.alt2.border};
    background: ${(props) => props.active ? 
      props.theme.colors.button.alt2.active.hover : props.theme.colors.button.alt2.hover};
  }
  &:focus {
    border: 1.25px solid ${(props) => props.active ? 
      props.theme.colors.button.alt2.active.hover : props.theme.colors.button.alt2.border};
  ...
  span {
    color: ${(props) => props.active ? 
      props.theme.colors.button.alt2.active.label : props.theme.colors.button.alt2.label};
  }
`;
export const IconTertiary = styled(IconPrimary)`
  svg {
    fill: ${(props) => props.disabled ?
    props.theme.colors.button.alt2.disabled.label : props.active ? 
    props.theme.colors.button.alt2.active.label : props.theme.colors.button.alt2.label};
  }
`;