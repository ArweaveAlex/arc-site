...
export default function Table(props: IProps) {
  ...
  const currentRecords = props.data
    ? props.data.slice(firstRecordIndex, lastRecordIndex)
    : null;
  const nPages = props.data
    ? Math.ceil(props.data.length / recordsPerPage)
    : null;
        ...
        return (
          <Paginator
            ...
            handleCursorFetch={(cursor: string | null) =>
              props.handleCursorFetch(cursor)
            }
