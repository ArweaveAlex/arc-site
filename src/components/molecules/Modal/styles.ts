...
export const Container = styled.div<{ noHeader: boolean }>`
	...
	width: 600px;
	max-width: 87.5vw;
	background: ${(props) => props.noHeader ? props.theme.colors.transparent : props.theme.colors.container.primary.background};
	border: 1px solid ${(props) => props.noHeader ? props.theme.colors.transparent : props.theme.colors.border.alt3};
	border-radius: ${STYLING.dimensions.borderRadiusWrapper};
	box-shadow: 0 0 2.5px ${(props) => props.noHeader ? props.theme.colors.transparent : props.theme.colors.shadow.primary};
	margin: 50px auto;
	overflow-y: auto;
