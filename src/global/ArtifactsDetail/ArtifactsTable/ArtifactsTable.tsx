...
import { formatDate, formatMessagingText, getTagValue } from "helpers/utils";

import * as urls from "helpers/urls";
import { IProps } from "./types";
import * as S from "./styles";

function CollectionToggle(props: { artifactId: string; selected: boolean; handleCollectionUpdate: (artifactId: string) => void }) {
	return (
		<S.CollectionToggle>
			<IconButton
				type={"primary"}
...
function Callback(props: { artifactId: string; selected: boolean; selectCallback: (artifactId: string) => void }) {
	return (
		<S.CheckboxContainer>
			<Checkbox checked={props.selected} disabled={false} handleSelect={() => props.selectCallback(props.artifactId)} />
		</S.CheckboxContainer>
	);
}
...
export default function ArtifactsTable(props: IProps) {
	...
	}, [collectionIdsState, selectedCallbackIdsState, props.data, props.showCollections]);
