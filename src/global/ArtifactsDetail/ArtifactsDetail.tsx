...
export default function ArtifactsDetail(props: IProps) {
  ...
  const searchIdsReducer = useSelector(
    (state: RootState) => state.searchIdsReducer
  );
  ...
  const [detailDataUpdated, setDetailDataUpdated] =
  ...
  return (
    <ArtifactsTable
      ...
      setSearchRequested={(searchRequested: boolean) =>
        setSearchRequested(searchRequested)
      }
